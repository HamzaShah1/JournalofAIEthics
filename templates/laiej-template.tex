% =============================================================
%  Journal of AI Ethics (LAIEJ) — Official Paper Template
...
%     The editor will assign a code (LAIEJ-YYYY-XXX) on acceptance.
...
%     papers/LAIEJ-YYYY-XXX/ and open a pull request.
%
